...
import * as actions from '../../actionsCreators/actions'
 ...
 class SeleccionarMedidoresReportes extends Component{
    ...
    renderItem = ({item}) =>{
        ...
        <View style={{alignSelf:"center",width:"90%"}}>
            ...
            {
                this.props.medidores.id === item.id ? (
    ...
    render(){
        ...
        const medidores = navigation.getParam('medidores', 'NO-MEASURES');
...
export default connect(mapStateToProps,actions)(SeleccionarMedidoresReportes); 
