...
import FloatButton from '../floatButton'
 ...
 class SolicitudesCerradas extends Component{
    ...
    async componentDidMount(){
        ...
        console.log("solicitudAbiertas")
        console.log(solicitudAbiertas)
        console.log("solicitudCerradas")
        console.log(solicitudCerradas)
        this.setState({data:solicitudCerradas,
            copyData:solicitudCerradas})
